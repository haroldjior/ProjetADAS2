...
package body gestion_donnees is
   ...
   procedure Reinitialiser_Archive is
      F : Archive_IO.File_Type;
   begin
      begin
         Archive_IO.Open (F, Archive_IO.Out_File, Nom_Fichier_Archive);
         Archive_IO.Close (F);
      exception
         when Archive_IO.Name_Error =>
            null;
      end;
   end Reinitialiser_Archive;
   ...
   begin
      ...
      teteM :=
        new T_cell_M'
          (init_mat
             (projection, 3, faire_date (16, avril, 2026), false, false),
           teteM);
      teteM :=
        new T_cell_M'
      ...
      teteM :=
        new T_cell_M'
          (init_mat
             (projection, 5, faire_date (17, avril, 2026), false, false),
           teteM);
      teteM :=
        new T_cell_M'
          (init_mat (sono, 6, faire_date (17, avril, 2026), false, false),
           teteM);
      teteM :=
        new T_cell_M'
          (init_mat (sono, 7, faire_date (18, avril, 2026), true, false),
           teteM);
      teteM :=
        new T_cell_M'
          (init_mat (camera, 8, faire_date (18, avril, 2026), true, false),
           teteM);
      teteM :=
        new T_cell_M'
      ...
      teteE :=
        new T_cell_E'
          (init_employe
             (faire_identite ("FER", "LUCIE"), false, 0, true, false),
           teteE);
      teteE :=
        new T_cell_E'
          (init_employe
      ...
      teteE :=
        new T_cell_E'
          (init_employe
             (faire_identite ("AURELE", "MARC"), true, 0, false, false),
           teteE);
      teteE :=
        new T_cell_E'
          (init_employe
             (faire_identite ("GALVIN", "LUC"), true, 0, false, false),
           teteE);
      ...
      -- dans init_donnees, après avoir créé teteL pour la location 3 :
      declare
         P_Galvin : T_Pteur_E :=
           recherche_employe (teteE, faire_identite ("GALVIN", "LUC"), true);
         P_Aurele : T_Pteur_E :=
           recherche_employe (teteE, faire_identite ("AURELE", "MARC"), true);
         P_Guerre : T_Pteur_E :=
           recherche_employe
             (teteE, faire_identite ("GUERRE", "MARTIN"), false);
         p        : T_pteur_L := teteL;
      begin
         while p /= null loop
            case p.loc.num is
               when 3      =>
                  p.loc.Intervenant := P_Galvin;  -- Luc Galvin

               when 1      =>
                  p.loc.Intervenant := P_Aurele;  -- Marc Aurele

               when 7      =>
                  p.loc.Intervenant := P_Guerre;  -- Martin Guerre
