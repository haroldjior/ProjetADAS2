      ...
      loop
         ...
         case C is
            ...
            when '5'    =>
               ...
               Saisie_Identite (Id);
               Visu_Locations_Employe (Tete_L, Archive, Id);
      ...
      loop
         ...
         case C is
            ...
            when '3'    =>
               ...
               Saisie_Identite (Id);
               Visu_Locations_Client (Tete_L, Archive, Id);
   ...
   begin
      loop
         ...
         case C is
            ...
            when '2'    =>
               Visu_Archives (Archive);

            when '3'    =>
               Put_Line ("--- Cloture des prestations terminees ---");
               Fin_Presta
                 (Tete_L, Archive, Date_Du_Jour, Tete_C, Tete_M, Tete_E);
   ...
   loop
      ...
      case Choix is
         ...
         when '6'    =>
            ...
            Visu_Date (Date_Du_Jour);
            New_Line;
            Fin_Presta (Tete_L, Archive, Date_Du_Jour, Tete_C, Tete_M, Tete_E);
            Traiter_Demande (File_D, Tete_M, Tete_E, Tete_L, Date_Du_Jour);
            Put_Line ("============================================");
